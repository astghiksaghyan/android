...
public class UniversalFileFilter implements FileFilter {
    ...
    private final boolean mAllowDirectories = true;
    private StorageChooser.FileType mFileType;
    private boolean mCustomEnumLock = false;
    private ArrayList<String> mCustomEnum;
    ...
    public UniversalFileFilter(boolean customLock, ArrayList<String> customEnum) {
        this.mCustomEnumLock = customLock;
        this.mCustomEnum = customEnum;
    }
    ...
    private boolean isFileExtension(File f) {
        ...
        try {
            if (mCustomEnumLock) {
                return mCustomEnum.contains(ext);
            } else {
